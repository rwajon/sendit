...
describe('User', () => {
  ...
  describe('GET /api/v1/users/:userId/parcels', () => {
    ...
    before(async () => {
      try {
        await db.query(
          "INSERT INTO orders VALUES(DEFAULT, 1,'John Smith', '+123456789', 'johnsmith@gmail.com', 'USA', 'Ney-York', 'Near Central Park', 'Sandals', '1.5 Kg', 2, 111, 'pending', 'USA, Ney-York - Central Park Av', DEFAULT)",
        );
      } catch (error) {
        console.log(error);
      }
