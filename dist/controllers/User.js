  ...
  _createClass(User, [{
    ...
    value: function signup(form) {
      ...
      if (form.fname && form.lname && form.uname && form.password && form.phone && form.country) {
        ...
        this.user = {
          ...
          lname: form.lname,
          uname: form.uname,
          password: _bcryptjs2.default.hashSync(form.password, 8),
          phone: form.phone,
          email: form.email,
    ...
    value: function signin(form) {
      ...
      if (Object.keys(form).length === 2 && form.uname !== '' && form.password !== '') {
        Object.keys(this.users).forEach(function (key) {
          if (_this2.users[key].uname === form.uname && _bcryptjs2.default.compareSync(form.password, _this2.users[key].password)) {
