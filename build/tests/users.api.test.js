...
describe('User', function () {
  describe('GET /users', function () {
    it('should display \'Please, sign-in!\'', function (done) {
      _chai2.default.request(_app2.default).get('/users').end(function (err, res) {
  ...
  // get user info
  describe('GET /users/0000', function () {
    it('should return the info of a specific user with the id: 001', function (done) {
      _chai2.default.request(_app2.default).get('/users/001').end(function (err, res) {
        expect(res.status).to.equal(200);
    ...
    it('should display \'Sorry, there is no user that corresponds to this id: 0000\'', function (done) {
      _chai2.default.request(_app2.default).get('/users/0000').end(function (err, res) {
        expect(res.status).to.equal(200);
  ...
  describe('Sign-in', function () {
    describe('POST /users/signin', function () {
      ...
      it('should return the user information if the account exists', function (done) {
        _chai2.default.request(_app2.default).post('/users/signin').send({
          uname: 'rwajon',
          password: '12345'
  ...
  describe('Sign-up', function () {
    describe('POST /users/signup', function () {
      ...
      it('should return the user information if the registration has succeeded', function (done) {
        _chai2.default.request(_app2.default).post('/users/signup').send({
          id: '001',
          fname: 'Jonathan',
          lname: 'Rwabahizi',
          uname: 'rwajon',
